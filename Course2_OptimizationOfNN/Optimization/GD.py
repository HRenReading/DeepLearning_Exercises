# -*- coding: utf-8 -*-
"""
Created on Fri May 10 21:00:45 2024
...
def Mini_BatchGD(x,y,layer_dim,n_epoch,batch_size,funhid,funout,gradfun,LR):
    "use gradient descent with mini batches update the parameters"
